...
const navItems = [
  {
    ...
    items: [
      ...
      { href: '/campaigns', label: 'Campaigns', icon: 'M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z', icon2: 'M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z' },
  ...
  },
  {
    label: 'System',
    items: [
      { href: '/settings/email-accounts', label: 'Email Accounts', icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
